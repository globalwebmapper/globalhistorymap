...
const SliderWithDatePanel: React.FC<SliderWithDatePanelProps> = (props) => {
  ...
  const [currDate, setCurrDate] = useState<moment.Moment | null>(moment("1891-07-02", "YYYY-MM-DD"));
  ...
  var sliderStart: number = moment("1783-01-01", "YYYY-MM-DD").unix();
  var sliderEnd: number = moment("2000-01-01", "YYYY-MM-DD").unix();
